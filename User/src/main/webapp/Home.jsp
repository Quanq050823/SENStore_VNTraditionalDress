...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs1-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/bgr_slide_01.png);">
				...
				<div class="item-slick1" style="background-image: url(images/bgr_slide_03.png);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
							...
							<div class="layer-slick1 animated visible-false" data-appear="lightSpeedIn" data-delay="800">
								<h2 class="ltext-104 cl2 p-t-19 p-b-43 respon1" style="max-width: 800px">
				...
				<div class="item-slick1" style="background-image: url(images/bgr_slide_05.png);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
		...
		<div class="flex-w flex-c-m">
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					<img src="images/bgr_item_1.png" alt="IMG-BANNER">

					<a href="product?action=getShop" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							<span class="block1-name ltext-102 trans-04 p-b-8" style="max-width: 60%">
								Traditional Ao Dai
							</span>
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="images/bgr_item_2.png" alt="IMG-BANNER">

					<a href="product?action=getShop" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							<span class="block1-name ltext-102 trans-04 p-b-8" style="max-width: 60%">
<%--								Traditional Costumes of Ancient Vietnam and China--%>
								Vietnamese Traditional Clothing
							</span>
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="images/bgr_item_3.png" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="images/bgr_item_4.png" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="images/bgr_item_5.png" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="images/update.png" alt="IMG-BANNER">
