...
<%--					</button>--%>
<%--				</c:forEach>--%>
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".${"TAD"}">
					Traditional Ao Dai
				</button>
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".${"VTC"}">
					Vietnamese Traditional Clothing
				</button>
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".${"MAD"}">
					Modern Ao Dai
				</button>
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".${"EG"}">
					Evening Gown
				</button>
		...
		<div class="row isotope-grid">
			...
			%>
			<c:if test="${product.category.categoryName == 'Traditional Ao Dai'}">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item TAD">
					<!-- Block2 -->
					<div class="block2">
			...
			<c:if test="${product.category.categoryName =='Vietnamese Traditional Clothing '}">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item VTC">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="data:image/jpeg;base64,<%=product.getImages().get(0).getProductImage()%>" alt="IMG-PRODUCT">
			...
			<c:if test="${product.category.categoryName =='Modern Ao Dai'}">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item MAD">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="data:image/jpeg;base64,<%=product.getImages().get(0).getProductImage()%>" alt="IMG-PRODUCT">
			...
			<c:if test="${product.category.categoryName=='Evening Gown'}">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item EG">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="data:image/jpeg;base64,<%=product.getImages().get(0).getProductImage()%>" alt="IMG-PRODUCT">
